...
import Pagemin from "./Pages/Page-Screen-tension/Page-Screen-tension"; // นำเข้าคอมโพเนนต์ Page1 จากไฟล์ "Page1.js" ในโฟลเดอร์เดียวกัน
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
          ...
          <Routes>
            ...
            <Route path="/page/min" element={<Pagemin />} />
          </Routes>
        </Box>
      </Box>
    </Router>
