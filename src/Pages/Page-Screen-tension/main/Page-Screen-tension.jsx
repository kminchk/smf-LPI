...
const ScreenTension = () => {
  ...
  const fetchdistinctproduct_name = async () => {
    try {
      const response = await axios.get(
        `http://10.17.77.111:3001/api/lpi_screen_tension_202308311026/distinctproduct_name`
      );
  ...
  const fetchdistinctprocess = async () => {
    try {
      const response = await axios.get(
        `http://10.17.77.111:3001/api/lpi_screen_tension_202308311026/distinctprocess?product_name=${selectproduct_name.product_name}`
      );
      const fetchDataAPItable = response.data;
  ...
  const fetchdistinctscreenno = async () => {
    try {
      const response = await axios.get(
        `http://10.17.77.111:3001/api/lpi_screen_tension_202308311026/distinctscreen_no?product_name=${selectproduct_name.product_name}&process=${selectprocess.process}`
      );
      const fetchDataAPItable = response.data;
  ...
  const fetchDataAPI = async () => {
    try {
      const response = await axios.get(
        `http://10.17.77.111:3001/api/lpi_screen_tension_202308311026/dataAPI?product_name=${selectproduct_name.product_name}&process=${selectprocess.process}&screen_no=${selectscreen_no.screen_no}`
      );
      const fetchDataAPItable = response.data;
