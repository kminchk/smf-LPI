...
export default function Page1() {
  ...
  const fetchdistinctfactory = async () => {
    try {
      const response = await axios.get(
        `http://127.0.0.1:3001/api/fpc_lse_alignment_noexp/distinctfactory`
      );
  ...
  const fetchdistinctmc_code = async () => {
    try {
      const response = await axios.get(
        `http://127.0.0.1:3001/api/fpc_lse_alignment_noexp/distinctmc_code?factory=${selectfactory.factory}`
      );
      const fetchDataAPItable = response.data;
  ...
  const fetchdistinctprocess = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:3001/api/fpc_lse_alignment_noexp/distinctprocess",
        {
          params: {
  ...
  const fetchdistinctpos_no = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:3001/api/fpc_lse_alignment_noexp/distinctpos_no",
        {
          params: {
            factory: selectfactory.factory,
            mc_code: selectmc_code.mc_code,
  ...
  const fetchdistinctproduct_name = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:3001/api/fpc_lse_alignment_noexp/distinctproduct_name",
        {
          params: {
            factory: selectfactory.factory,
            mc_code: selectmc_code.mc_code,
  ...
  const fetchDataAPItable = async () => {
    try {
      const response = await axios.get(
        `http://127.0.0.1:3001/api/fpc_lse_alignment_noexp/table?factory=${selectfactory.factory}&mc_code=${selectmc_code.mc_code}&process=${selectprocess.process}&pos_no=${selectpos_no.pos_no}&product_name=${selectproduct_name.product_name}`
      );
      const fetchDataAPItable = response.data;
